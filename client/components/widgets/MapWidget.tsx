...
const HOTSPOTS: Hotspot[] = [
  { name: "Delhi", coords: [28.6139, 77.2090], description: "Red Fort, Qutub Minar, rich Mughal heritage", link: "/resources" },
  { name: "Varanasi", coords: [25.3176, 82.9739], description: "Spiritual ghats on the Ganga", link: "/resources" },
  { name: "Jaipur", coords: [26.9124, 75.7873], description: "Pink City, forts & palaces", link: "/library" },
  { name: "Mumbai", coords: [19.076, 72.8777], description: "Gateway of India, arts & cinema", link: "/library" },
  { name: "Hampi", coords: [15.335, 76.46], description: "UNESCO ruins of Vijayanagara", link: "/resources" },
  { name: "Kochi", coords: [9.9312, 76.2673], description: "Backwaters, Kathakali, spice trade", link: "/library" },
  { name: "Kolkata", coords: [22.5726, 88.3639], description: "Intellectual capital, Durga Puja", link: "/forum" },
];
